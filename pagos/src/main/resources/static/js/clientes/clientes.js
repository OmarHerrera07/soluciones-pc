		...
		clientes.forEach(function(cliente) {
			tabla.append(`
                        ...
                        <td>
                            ...
                            <button data-bs-toggle="modal" data-bs-target="#modal-confirmar-pago" onclick="confirmarPago('${cliente.idCliente}','${cliente.nombre}','${cliente.paquete}');" class="btn btn-success">
