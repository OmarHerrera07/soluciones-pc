		...
		clientes.forEach(function(cliente) {
			tabla.append(`
                        ...
                        <td>
                            ...
                            <button ${cliente.estado != 2 ? '' : 'disabled'} data-bs-toggle="modal" data-bs-target="#modal-confirmar-pago" onclick="confirmarPago('${cliente.idCliente}','${cliente.nombre}','${cliente.paquete}','${cliente.abono}');" class="btn btn-success">
